...
import { projectRoot, resolveQuiverAuth, writeToolArtifacts, LOGIN_HINT } from "../../../core/tooling"
...
import type { BacktestMetadata, BacktestArtifactPaths } from "./report-types"
import { toReport, toDashboard } from "./render"
import { parseChartBars, fetchYahooDailyBars, fetchSector } from "./market-data"
import { selectBenchmarksByTicker, computePortfolioBenchmarkRelativeRows } from "./report-benchmark"
import { buildRunComparison } from "./comparison"
import { listPortfolio } from "../../portfolio/service"
  ...
  return {
    ...
    async execute(params, ctx) {
      ...
      const priceBySymbol = (
        ...
        {} as Record<string, import("./types").PriceBar[]>,
      )
