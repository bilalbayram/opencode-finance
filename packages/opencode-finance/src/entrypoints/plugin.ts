...
import { exists, readText, writeText } from "../core/fs"
import { PortfolioTool, PortfolioReportTool } from "../features/portfolio"
import { reportExecutionConstraintLines } from "../features/reports/company/report-execution-constraints"
import { ReportDarkpoolAnomalyTool } from "../features/reports/darkpool-anomaly"
import { ReportEvaluationTool } from "../features/reports/evaluation/tool"
import { ReportGovernmentTradingTool } from "../features/reports/government-trading"
import { ReportInsidersTool } from "../features/reports/insiders"
import { ReportPdfTool } from "../features/reports/pdf"
import { FinancialPoliticalBacktestTool } from "../features/reports/political-backtest"
import { FinancialSearchTool } from "../features/search"
import { FINANCE_AUTH_PROVIDER, type FinanceAuthProviderID } from "../integrations/finance/auth-provider"
import { resolveProviderApiKey } from "../integrations/finance/credentials"
import { FINANCE_SLASH_COMMANDS } from "./commands/finance"
import PROMPT_FINANCE from "./prompts/finance.txt"
...
const BUNDLED_SKILL = path.resolve(MODULE_DIR, "./skills/finance-comprehensive-report.SKILL.md")
